...
import { Sliders, Sparkles, Loader2, RotateCw, Sun, Box, Palette, Cpu, Check } from "lucide-react";
    ...
    <div className="bg-slate-900/90 rounded-2xl border border-slate-700/80 p-4 shadow-xl backdrop-blur-xl space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold text-white tracking-wide uppercase">
            Perspective & Blending Engines
          </h2>
        </div>
        <span className="text-[11px] text-emerald-300 font-mono font-semibold bg-emerald-950/60 border border-emerald-500/30 px-2 py-0.5 rounded-full">
          5 State-of-the-Art Engines
        </span>
      </div>
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          <span className="text-[10px] uppercase font-mono font-bold text-slate-300 flex items-center gap-1.5">
            ...
            <span>Select Blending & Lighting Engine:</span>
          </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 pt-1">
        ...
        <div className="space-y-1 bg-slate-950/50 p-2.5 rounded-xl border border-slate-800">
          <div className="flex items-center justify-between text-[11px]">
            <span className="text-slate-300 font-medium flex items-center gap-1">
              <Sun className="w-3 h-3 text-amber-400" /> Room Shadow Blend:
            </span>
        ...
        >
          {isRendering ? (
            <>
              ...
              <span>Synthesizing Realistic Tiles...</span>
            </>
          ) : (
            <>
              <Sparkles className="w-4 h-4 text-white" />
              <span>✨ Render Tiles onto Room</span>
            </>
          )}
        </button>
      </div>
